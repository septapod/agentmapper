...
export default function FutureStateWorkflowPage() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold">Future State Workflow Design</h1>
            <p className="text-[var(--color-text-muted)]">Exercise 2 of 4 · Session 3</p>
          </div>
        </div>
      </motion.div>
          ...
          <CardContent>
            ...
            <div className="bg-[var(--color-surface-hover)] rounded-lg p-4 mb-4">
              ...
              <p className="text-sm text-[var(--color-text-muted)] mb-3">
                Future State Workflow Design helps you visualize how work will flow after implementing AI.
                This exercise will guide you through:
              </p>
              <ul className="space-y-2 text-sm text-[var(--color-text-muted)]">
                <li>• Mapping the current-state workflow (as-is process)</li>
                <li>• Designing the future-state workflow with AI integration</li>
                <li>• Identifying where humans stay in the loop vs. where AI takes over</li>
                <li>• Documenting handoff points between human and AI steps</li>
                <li>• Visualizing time savings and error reduction opportunities</li>
              </ul>
            </div>
            ...
            <div className="bg-[var(--color-accent-coral)]/10 border border-[var(--color-accent-coral)]/20 rounded-lg p-4">
              ...
              <p className="text-sm text-[var(--color-text-muted)]">
                ...
                The workflow design insights will be incorporated into future versions of this tool.
              </p>
            </div>
          </CardContent>
        </Card>
