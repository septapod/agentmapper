    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold">Risk & Governance Assessment</h1>
            <p className="text-[var(--color-text-muted)]">Exercise 3 of 4 · Session 3</p>
          </div>
        </div>
      </motion.div>
          ...
          <CardContent>
            ...
            <div className="bg-[var(--color-surface-hover)] rounded-lg p-4 mb-4">
              ...
              <p className="text-sm text-[var(--color-text-muted)] mb-3">
                Risk & Governance Assessment helps you proactively identify and mitigate risks before launching your AI pilot.
                This exercise will guide you through:
              </p>
              <ul className="space-y-2 text-sm text-[var(--color-text-muted)]">
                <li>• Identifying technical risks (accuracy, bias, edge cases)</li>
                <li>• Assessing compliance and regulatory considerations</li>
                <li>• Defining governance structures and decision authority</li>
                <li>• Creating escalation paths for when AI gets it wrong</li>
                <li>• Establishing monitoring and audit requirements</li>
              </ul>
            </div>
            ...
            <div className="bg-[var(--color-accent-coral)]/10 border border-[var(--color-accent-coral)]/20 rounded-lg p-4">
              ...
              <p className="text-sm text-[var(--color-text-muted)]">
                ...
                The risk assessment insights will be incorporated into future versions of this tool.
              </p>
            </div>
          </CardContent>
        </Card>
